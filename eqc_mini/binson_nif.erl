...
-export([init/0, ver/0, writer_init/0, writer_reset/0,
    ...
    parser_init/1,
    parser_go_into_object/0, parser_leave_object/0,
    parser_go_into_array/0, parser_leave_array/0,
    parser_field/1, parser_next/0,
...
parser_leave_object()       -> nif_error().
parser_go_into_array()      -> nif_error().
parser_leave_array()        -> nif_error().
parser_field(_)             -> nif_error().
parser_next()               -> nif_error().
