...
#------ Primitives encoding ------
    ...
    def encode(string) when is_binary(string) do
        ...
        cond do
            len < 0x100     -> <<@bs_str_len8,  len::size(8)-integer-little,  string::binary>>
            len < 0x10000   -> <<@bs_str_len16, len::size(16)-integer-little, string::binary>>
    ...
    def encode({:bin, bytes}) do
        len = byte_size(bytes)
        cond do
            len < 0x100     -> <<@bs_byte_len8,  len::size(8)-integer-little,  bytes::binary>>
            len < 0x10000   -> <<@bs_byte_len16, len::size(16)-integer-little, bytes::binary>>
